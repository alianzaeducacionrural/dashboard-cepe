...
function crearHojas() {
  ...
  asegurarHojaConEncabezados_(CONFIG.SHEETS.INDICADORES_MEL, ['id', 'nombre', 'periodicidad', 'meta', 'alcanzado', 'pct_cumplimiento', 'corresponde_medicion', 'se_midio', 'observaciones']);
...
function sembrarDatosReales() {
  ...
  sembrarSiVacia_(CONFIG.SHEETS.INDICADORES_MEL, [
    { id: 'MEL1', nombre: '% de directivos docentes que completan las microcredenciales de liderazgo', periodicidad: 'Anual', meta: '', alcanzado: '', pct_cumplimiento: '', corresponde_medicion: false, se_midio: 'No', observaciones: 'No contempla medición en este periodo.' },
    { id: 'MEL2', nombre: '% de directivos docentes que lideran espacios de articulación (mesas de diálogo)', periodicidad: 'Trimestral', meta: '', alcanzado: '', pct_cumplimiento: '', corresponde_medicion: true, se_midio: 'Sí', observaciones: 'No aplica.' },
    { id: 'MEL3', nombre: 'Número de mesas permanentes de diálogo familia-escuela-estudiante activas', periodicidad: 'Semestral', meta: '', alcanzado: '', pct_cumplimiento: '', corresponde_medicion: true, se_midio: 'Sí', observaciones: 'No aplica.' },
    { id: 'MEL4', nombre: '% de estudiantes que mejoran resultados académicos (prueba entrada/salida)', periodicidad: 'Semestral', meta: '', alcanzado: '', pct_cumplimiento: '', corresponde_medicion: true, se_midio: 'Parcial', observaciones: '1 estudiante de la IE La Cabaña no presentó la prueba por motivos de salud.' },
    { id: 'MEL5', nombre: '# de herramientas digitales diseñadas para seguimiento a egresados', periodicidad: 'Mensual', meta: '', alcanzado: '', pct_cumplimiento: '', corresponde_medicion: true, se_midio: 'Sí', observaciones: 'No aplica.' },
    { id: 'MEL6', nombre: 'Número de IE que aplican protocolo de tránsito media-posmedia', periodicidad: 'Trimestral', meta: '', alcanzado: '', pct_cumplimiento: '', corresponde_medicion: true, se_midio: 'Sí', observaciones: 'No aplica.' },
    { id: 'MEL7', nombre: '% de estudiantes rurales beneficiados con canasta educativa', periodicidad: 'Anual', meta: '', alcanzado: '', pct_cumplimiento: '', corresponde_medicion: true, se_midio: 'Sí', observaciones: 'No aplica.' },
    { id: 'MEL8', nombre: 'Tasa de retención de estudiantes rurales universitarios', periodicidad: 'Bimensual', meta: '', alcanzado: '', pct_cumplimiento: '', corresponde_medicion: true, se_midio: 'Sí', observaciones: 'No aplica.' },
    { id: 'MEL9', nombre: '% de recomendaciones de Comités Académicos implementadas', periodicidad: 'Trimestral', meta: '', alcanzado: '', pct_cumplimiento: '', corresponde_medicion: true, se_midio: 'Sí', observaciones: 'No aplica.' },
    { id: 'MEL10', nombre: '% de estudiantes de media matriculados en técnicos 2026 vs. 2025', periodicidad: 'Anual', meta: '', alcanzado: '', pct_cumplimiento: '', corresponde_medicion: true, se_midio: 'Sí', observaciones: 'No aplica.' },
  ]);
